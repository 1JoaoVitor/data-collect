...
class Collector: # construção de um objeto 
    ...
    def auto_exec(self, save_format='json', date_stop='2000-01-01'): # função para executar várias vezes 
         page = 1 
         while True:
                print(page) # para acompanhar em que página está
